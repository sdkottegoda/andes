...
public class AlwaysOnMessageCacheImpl extends ExtendedMessageCacheImpl{
     ...
     */
    public AlwaysOnMessageCacheImpl(StorageQueue storageQueue) {
        super(storageQueue);
    ...
    public void disable() {
        throw new UnsupportedOperationException("AlwaysOnMessageCacheImpl cannot be disabled");
    }
